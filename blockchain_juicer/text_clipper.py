...
def clip_text(input_file=None, delimiter=None, start_date=None, interval=None):
    ...
    sanity_status = file_operations.sanity_check(input_file=input_file, delimiter=delimiter)
...
if __name__ == '__main__':
    ...
    file_operations.initial_message(os.path.basename(__file__), custom_message=message)
    ...
    command_center(input_file=args.input_file, delimiter=_delimiter, start_date=start_date, interval=args.interval)